package kr.co.takeit.spring.util;
 ...
 * @author wschun 
 */ 
public class RefreshableSqlSessionFactoryBean extends SqlSessionFactoryBean implements DisposableBean, ApplicationContextAware { 
